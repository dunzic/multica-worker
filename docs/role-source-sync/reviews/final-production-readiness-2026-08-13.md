...
| RS-06 provenance, rollback and retention | GO, destructive workers disabled after the local six-case hold/policy/pin/prune matrix, 10,000-snapshot exact-SQL scale gate and five-pass immutable purge-receipt gate | NO-GO pending candidate-topology primary-failover race/scale repeat, retention RACI, versioned-object purge/provider accounting reconciliation and recorded restore with RPO/RTO |

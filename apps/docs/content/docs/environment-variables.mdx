...
| `S3_ENDPOINT_URL` | empty | Preferred S3-compatible endpoint such as MinIO; scoped to S3 only |
| `AWS_ENDPOINT_URL` | empty | Legacy `S3_ENDPOINT_URL` alias; forbidden in KMS-backed DR jobs |
